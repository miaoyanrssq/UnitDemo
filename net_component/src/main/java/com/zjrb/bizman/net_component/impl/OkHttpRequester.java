...
import com.zjrb.bizman.arouter_component.RouterPath;
...
public class OkHttpRequester implements IApiReuqester {
    ...
    private LogService logService = logService = (LogService) ARouter.getInstance().build(RouterPath.LOG_SERVICE_URL).navigation();
