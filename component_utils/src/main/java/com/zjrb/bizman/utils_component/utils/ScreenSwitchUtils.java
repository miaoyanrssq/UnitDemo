...
public class ScreenSwitchUtils {
    ...
    public class OrientationSensorListener implements SensorEventListener {
        ...
        public void onSensorChanged(SensorEvent event) {
             ...
             * 判断系统同事是锁定的与否 
             */
            if (rotateHandler != null && !getIsOritationLocked()) {
     ...
     * @return
     */
    private boolean getIsOritationLocked() {
        return SystemSettingUtil.getScreenRotation(mActivity.getContentResolver()) == SystemSettingUtil.ORITATION_LOCKED;
    }
